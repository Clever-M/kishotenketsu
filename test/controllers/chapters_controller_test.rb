...
class ChaptersControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post novel_chapters_url(@chapter.volume.novel), params: { chapter: { body: "Lorem Ipsum", title: "A test title", novel_id: @chapter.volume.novel.id } }
  #   end

  #   assert_redirected_to novel_url(@chapter.volume.novel)
  # end

  # test "should show chapter" do
  #   get novel_chapter_url(@chapter.volume.novel, @chapter)
  #   assert_response :success
  # end

  # test "should get edit" do
  #   get edit_novel_chapter_url(@chapter.volume.novel.id, @chapter.id)
  #   assert_response :success
  # end
